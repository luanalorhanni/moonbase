...
export function paletteCss(palette: Palette): string {
  ...
  const surfaces = (h: number, c: number, isDark: boolean) =>
    isDark
      ? {
          background: `oklch(0.21 ${c} ${h})`,
          backgroundDeep: `oklch(0.16 ${c} ${h})`,
          card: `oklch(0.27 ${c} ${h})`,
          popover: `oklch(0.29 ${c} ${h})`,
          secondary: `oklch(0.31 ${c} ${h})`,
          muted: `oklch(0.32 ${c} ${h})`,
          input: `oklch(0.31 ${c} ${h})`,
          sidebar: `oklch(0.24 ${c} ${h})`,
          sidebarAccent: `oklch(0.30 ${c} ${h})`,
        }
      : {
          background: `oklch(0.97 ${c} ${h})`,
          backgroundDeep: `oklch(0.93 ${c} ${h})`,
          card: `oklch(0.995 ${c * 0.3} ${h})`,
          popover: `oklch(0.995 ${c * 0.3} ${h})`,
          secondary: `oklch(0.94 ${c} ${h})`,
          muted: `oklch(0.95 ${c} ${h})`,
          input: `oklch(0.95 ${c} ${h})`,
          sidebar: `oklch(0.945 ${c} ${h})`,
          sidebarAccent: `oklch(0.91 ${c * 1.2} ${h})`,
        };
