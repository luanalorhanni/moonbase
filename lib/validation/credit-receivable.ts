...
export const creditReceivableFormSchema = z.object({
...
export type CreditReceivableFormInput = z.infer<typeof creditReceivableFormSchema>;

export type CreditReceivableActionData = {
  description: string;
  cardId: string;
  purchaseDate: string;
  totalParcels: number;
...
export function normaliseCreditReceivableForm(
  input: CreditReceivableFormInput,
): CreditReceivableActionData {
  return {
